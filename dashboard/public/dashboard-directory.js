const dashboards = [
  ...
  { group: 'Clean-slate clients', name: 'Logic Analyzer', detail: 'Digital waveform timing', path: '/next/logic-analyzer/index.html' },
  { group: 'Clean-slate clients', name: 'SCADA PowerGrid', detail: 'Substation SLD mimic', path: '/next/scada-powergrid/index.html' },
  { group: 'Clean-slate clients', name: 'Flight Annunciator', detail: 'Aerospace master warning', path: '/next/flight-annunciator/index.html' },
  { group: 'Clean-slate clients', name: 'Broadcast Switcher', detail: 'MCR production switcher', path: '/next/broadcast-switcher/index.html' },
  { group: 'Clean-slate clients', name: 'Audio Mixer', detail: 'Large-format summing desk', path: '/next/audio-mixer/index.html' },
  { group: 'Clean-slate clients', name: 'CNC Machining', detail: '5-Axis G-code controller', path: '/next/cnc-machining/index.html' },
  { group: 'Clean-slate clients', name: 'Robotics Teleop', detail: 'Planetary rover GDS', path: '/next/robotics-teleop/index.html' },
  { group: 'Clean-slate clients', name: 'Network NOC', detail: 'BGP mesh & DWDM matrix', path: '/next/network-noc/index.html' },
  { group: 'Clean-slate clients', name: 'Microscope Spectrometry', detail: 'Analytical SEM & EDX', path: '/next/microscope-spectrometry/index.html' },
  { group: 'Clean-slate clients', name: 'Reactor Core', detail: 'Class 1E safety & SPDS', path: '/next/reactor-core/index.html' },
  { group: 'WebGL control spaces', name: 'Swarm Nebula', detail: 'Instanced particle command sphere', path: '/next/swarm-nebula/index.html' },
  { group: 'WebGL control spaces', name: 'Flowfield Command', detail: 'GPU execution-flow corridors', path: '/next/flowfield-command/index.html' },
  { group: 'WebGL control spaces', name: 'Voxel Foundry', detail: 'Instanced fabrication cell', path: '/next/voxel-foundry/index.html' },
  { group: 'Clean-slate control planes', name: 'Operations Console', detail: 'Dense expert swarm operations', path: '/control-planes/ops-console/index.html' },
  { group: 'Clean-slate control planes', name: 'Guided Flow', detail: 'Governed plan and review workflow', path: '/control-planes/guided-flow/index.html' },
  { group: 'Clean-slate control planes', name: 'Spatial Topology', detail: '3D live swarm topology', path: '/control-planes/spatial-topology/index.html' },
  { group: 'Clean-slate control planes', name: 'Temporal Mission', detail: '3D longitudinal mission view', path: '/control-planes/temporal-mission/index.html' },
  { group: 'Fully spatial 3D control planes', name: 'Memory Palace', detail: 'Architectural archive workstations', path: '/next/memory-palace/index.html' },
  { group: 'Fully spatial 3D control planes', name: 'Jacquard Swarmworks', detail: 'Mechanical control loom', path: '/next/jacquard-swarmworks/index.html' },
  { group: 'Fully spatial 3D control planes', name: 'Command Cavern', detail: 'Ray-marched tectonic console', path: '/next/command-cavern/index.html' },
