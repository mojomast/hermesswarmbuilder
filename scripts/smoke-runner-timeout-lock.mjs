...
try {
  ...
  if(process.platform === 'linux') {
    ...
    const unrelatedPending={schemaVersion:'apb.next-run-request.v1',id:'unrelated-pending',status:'pending',type:'continue',sourceRunId:'other-run',sourceIterationId:'other-iteration',repoPath:timed.home,baseRef:'HEAD',objective:'unrelated',changeText:'unrelated',limits:{maxIterations:1,maxVariantsPerIteration:1,maxParallelVariantsPerIteration:1,maxParallelVariants:1,maxAcceptedFeatures:1,maxVisualMotifChanges:0,maxNewSections:0,stopAfterNoImprovement:1}};
